        ...
        <div class="container">
            <div class="row g-5 align-items-start">
                <div class="col-lg-6" data-aos="fade-right">
                    ...
                    <div class="row g-2">
                        <div class="col-3">
                            <img src="img/casco-qrescueid-fluor-nocturno_resultado.webp"
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    ...
                    <p class="lead text-light mb-3">Incluye 2 QRescueID físicos, 1 año de Plan Premium y 20% de
                        descuento en QRescueID físicos adicionales.</p>
                    <div class="mb-1">
                        <small class="text-decoration-line-through"
                            style="color: var(--golden-yellow) !important; opacity: 0.7;">$40.000</small>
                    </div>
                    <div class="pricing-price mb-3">
                        <span class="price-currency" style="color: var(--golden-yellow) !important;">$</span>
                        <span class="price-amount" style="color: var(--golden-yellow) !important;">36.990</span>
                    ...
                    <ul class="list-unstyled feature-list">
                        <li class="mb-2"><i class="fas fa-box-open me-2 text-warning"></i>2 unidades físicas QRescueID
                        </li>
                        <li class="mb-2"><i class="fas fa-crown me-2 text-warning"></i>1 año de Plan Premium</li>
                        <li class="mb-2"><i class="fas fa-percent me-2 text-warning"></i>20% de descuento en adicionales
                        </li>
